...
contract spChrDepositContract is Ownable, ReentrancyGuard {
    ...
    constructor(address _spChrToken) Ownable(msg.sender) {
        spChrToken = IERC20(_spChrToken);
    ...
    function withdraw(uint256 amount) external onlyOwner {
        // Owner can withdraw spChrToken tokens from the contract
        spChrToken.transfer(owner(), amount);
    }
}
